  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row ">
      <div class="text-center navbar-brand-wrapper ">
        <a class="navbar-brand brand-logo " href="{{URL::to('/admin_dashboard')}}"><img src="{{asset('images/logo.png')}}" style="height: 65px;width: 140px;" alt="Logo"></a>
      </div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              ...
              <a class="dropdown-item" href="{{URL::to('/logout')}}">
                <div class="sender-img">
                  <img src="{{asset('images/logout.jpg')}}" alt="">
                </div>
                <div class="sender">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Sudipto Sarker</p>
              <p class="designation" style="color: orange;">Admin</p>
            </div>
          </div>
          <ul class="nav">
            <!--main pages start-->
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/ba')}}">BA</a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="validationSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/forms/form-validation.html">Addmission </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/forms/bt-maxlength.html">NoticeBoard</a>
                  </li>
                </ul>
              </div>
            </li>
