            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="post"  action="{{url('studentlogin')}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input" name="student_email" placeholder="Student Email">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input type="text" class="form-control p_input" name="student_password" placeholder="Student Password">
                </div>
