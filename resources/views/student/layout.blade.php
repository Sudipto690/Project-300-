      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Amit</p>
              <p class="designation" style="color: orange;">Student</p>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" >CSE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" >EEE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" >BBA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" >LLB</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" >BA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" >CIVIL</a>
                  </li>
                </ul>
              </div>
            </li>
